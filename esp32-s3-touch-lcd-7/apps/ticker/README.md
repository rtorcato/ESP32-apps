...
| Settings scroll | Twelve rows, one scroll step | Shutdown, Scroll, Columns, Orientation, Clock, Background (black, navy, forest, plum), Auto return, Sleep, Currency, Info, Wi-Fi, Clear device. |
